...
(function(){
    ...
    // check parameters
	if (!hasValidParameters()) { console.error('No valid parameters for MQTT in Reveal.initialize'); return; }
	...
	// connect MQTT
	var conn_options = {userName: configs.mqtt_username, password: configs.mqtt_password, timeout: 5, onSuccess: onConnect, onFailure: onFailure};
